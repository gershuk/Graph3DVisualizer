...
//     version 1.7.0
//     from Assets/Player/Scripts/FlyPlayer/FlyControls.inputactions
//
...
{
    public partial class @FlyControls: IInputActionCollection2, IDisposable
    {
    ...
    ""controlSchemes"": []
        ...
        private List<IFlyModelActions> m_FlyModelActionsCallbackInterfaces = new List<IFlyModelActions>();
        ...
        public struct FlyModelActions
        {
            ...
            public void AddCallbacks(IFlyModelActions instance)
            {
                if (instance == null || m_Wrapper.m_FlyModelActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_FlyModelActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IFlyModelActions instance)
            {
                @MoveToPoint.started -= instance.OnMoveToPoint;
                @MoveToPoint.performed -= instance.OnMoveToPoint;
                @MoveToPoint.canceled -= instance.OnMoveToPoint;
            ...
            public void RemoveCallbacks(IFlyModelActions instance)
            {
                if (m_Wrapper.m_FlyModelActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IFlyModelActions instance)
            {
                foreach (var item in m_Wrapper.m_FlyModelActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_FlyModelActionsCallbackInterfaces.Clear();
