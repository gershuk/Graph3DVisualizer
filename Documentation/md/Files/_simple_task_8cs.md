...
|                | Name           |
| -------------- | -------------- |
| class | **[Graph3DVisualizer::GraphTasks::SimpleTask](Classes/class_graph3_d_visualizer_1_1_graph_tasks_1_1_simple_task.md)** <br>Example of implementing a graph visual task.  |
